    ...
    render() {
        ...
        <div className="formcenter">
            <form onSubmit={this.handleSubmit} className="formfields">
              ...
              <div className="formfield">
                <label className="formfield-label" htmlfor="repassword">Retype Password</label>
                <input type="password" id="repassword" className="formfield-input" placeholder="Enter your password again" name="repassword" value={this.state.repassword} onchange={this.handlechange} />
              </div>
              <div className="formfield">
              ...
              <div className="formfield">
                <label className="formfield-checkboxlabel">
                    <input className="formfield-checkbox" type="checkbox" name="hasAgreed" value={this.state.hasAgreed} onchange={this.handlechange} /> i agree all statements in <a href="" className="formfield-Termslink">terms of service</a>
                </label>
              </div>
