  ...
  render() {
      ...
      <div className="formcenter">
          <form onSubmit={this.handleSubmit} className="formfields">
            ...
            <div className="formfield">
              <label className="formfield-label" htmlfor="address">Address</label>
              <input
                type="text"
                id="address"
                className="formfield-input"
            ...
            <div className="formfield">
              ...
              <input type="email" id="email" className="formfield-input" placeholder={this.state.email} name="email" value={this.state.email} onChange={this.handleChange} disabled="disabled" />
            </div>
            <div className="formfield">
              <label className="formfield-label" htmlfor="phone">Phone Number</label>
              <input
                type="number"
                id="phone"
                className="formfield-input"
            ...
            <div className="formfield">
                <label className="formfield-link">My History</label>
            </div>
          </form>
        </div>
      );
